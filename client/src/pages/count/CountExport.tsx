...
const agentTree = [
  {
    ...
    children: [
      { title: '吴飞龙1 (1/总3)', key: 'agent-1', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙2 (0/总0)', key: 'agent-2', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙3 (0/总0)', key: 'agent-3', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙4 (0/总0)', key: 'agent-4', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙5 (0/总0)', key: 'agent-5', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙6 (0/总0)', key: 'agent-6', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙7 (0/总0)', key: 'agent-7', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙8 (0/总0)', key: 'agent-8', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙9 (0/总0)', key: 'agent-9', icon: <UsergroupAddOutlined /> },
      { title: '吴飞龙10 (0/总0)', key: 'agent-10', icon: <UsergroupAddOutlined /> },
    ],
  },
];
