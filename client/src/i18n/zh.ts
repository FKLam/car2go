export default {
  ...
  devices: { title: '设备管理', menuList: '设备管理', menuUserInfo: '客户资料', menuBatchImport: '批量修改设备信息', menuBatchIcon: '批量修改设备图标', menuTransform: '设备批量转移', menuUpdateTime: '批量修改设备时间', menuImportIccid: '导入卡号', menuExportIccid: '卡号匹配', menuUpdateExpire: '刷新设备到期时间', menuHuaxiang: '华祥管理平台数据导入', menuUpdateHost: '批量修改主机名', '设备管理', addDevice: '添加设备', deviceTree: '设备分组', deviceName: '设备名称', imei: 'IMEI', plateNumber: '车牌号', simNumber: 'SIM卡号', model: '设备型号', group: '所属分组', driverName: '驾驶员', driverPhone: '联系电话', lastPosition: '最后位置', lastOnline: '最后上线', emptyGroup: '暂无分组', emptyDevice: '暂无设备' },
