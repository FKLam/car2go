export default {
  ...
  menu: { monitor: '监控平台', dashboard: '仪表盘', map: '实时追踪', devices: '我的设备', count: '数据统计', track: '轨迹回放', geofences: '电子围栏', commands: '远程指令', alerts: '报警列表' },
  ...
  devices: { title: '设备管理', menuList: '设备管理', menuUserInfo: '客户资料', menuBatchImport: '批量修改设备信息', menuBatchIcon: '批量修改设备图标', menuTransform: '设备批量转移', menuUpdateTime: '批量修改设备时间', menuImportIccid: '导入卡号', menuExportIccid: '卡号匹配', menuUpdateExpire: '刷新设备到期时间', menuHuaxiang: '华祥管理平台数据导入', menuUpdateHost: '批量修改主机名', addDevice: '添加设备', deviceTree: '设备分组', deviceName: '设备名称', imei: 'IMEI', plateNumber: '车牌号', simNumber: 'SIM卡号', model: '设备型号', group: '所属分组', driverName: '驾驶员', driverPhone: '联系电话', lastPosition: '最后位置', lastOnline: '最后上线', emptyGroup: '暂无分组', emptyDevice: '暂无设备' },
  count: { menuMileage: '里程统计', menuAlarms: '报警统计', menuStayDetail: '停留点详细', menuExport: '统计数据导出' },
